...
document.querySelectorAll('.RFEST .box img').forEach(function(img) {
    img.addEventListener('click', function() {
      window.open('https://www.instagram.com/resplandor_bvec/', 'https://www.instagram.com');
    });
  });
...
galleryAnimation(".feedback .voices", [".feedback .voices .box1",".feedback .voices .box2",".feedback .voices .box3",".feedback .voices .box4",".feedback .voices .box5",".feedback .voices .box6" ,".feedback .voices .box7"])
